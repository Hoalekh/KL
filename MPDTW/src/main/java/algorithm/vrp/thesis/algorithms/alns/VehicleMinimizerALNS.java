package algorithm.vrp.thesis.algorithms.alns;

import algorithm.vrp.thesis.algorithms.operators.insertion.RegretInsertion;
import algorithm.vrp.thesis.algorithms.operators.noise.NoiseOperator;
import algorithm.vrp.thesis.algorithms.operators.removal.RandomRemoval;
import algorithm.vrp.thesis.algorithms.operators.removal.ShawRemoval;
import algorithm.vrp.thesis.algorithms.operators.removal.WorstRemoval;
...
public class VehicleMinimizerALNS extends ALNS {
    ...
    public VehicleMinimizerALNS(Instance instance, Random random) {
