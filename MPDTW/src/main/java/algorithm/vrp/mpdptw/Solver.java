...
import algorithm.vrp.mpdptw.aco.SequentialFeasiblePDPTW;
import algorithm.vrp.mpdptw.aco.SolutionBuilder;
...
public class Solver implements Runnable {
    ...
    private void printFinalRoute() {
        ...
        MapPrinter.printResult(ant, instance, 1200, 1000, problemName+"_aco");
    }
