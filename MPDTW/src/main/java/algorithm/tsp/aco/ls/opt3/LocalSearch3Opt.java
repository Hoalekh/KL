package algorithm.tsp.aco.ls.opt3;
...
public class LocalSearch3Opt {
    ...
    public static void three_opt_first(Random random, int tour[], int n, int[][] distance, int nn_list[][], int nn_ls) {
        /*
            ...
            for (l = 0; l < n; l++) {
                ...
                while (h < nn_ls) {
                    ...
                    if (radius > add1) {
                        ...
                        diffp = -radius - distance[c2][p_c2] + distance[c1][p_c2]
                                + distance[s_c1][c2];
                    } else
                        break;
                        ...
                        if (c3 == c1) {
                            ...
                            if (decrease_breaks + add1 < add2) {
                                ...
                                if (between) {
                                    ...
                                    gain = decrease_breaks - distance[c3][p_c3] + add1 + add2
                                            + distance[p_c3][s_c2];
                                    ...
                                    gain = decrease_breaks - distance[c3][s_c3] + add1 + add2
                                            + distance[s_c2][s_c3];
                                    ...
                                    gain = -radius - distance[p_c2][c2] - distance[p_c3][c3]
                                            + add1 + add2 + distance[p_c2][p_c3];
                                    ...
                                    gain = -radius - distance[p_c2][c2] - distance[c3][s_c3]
