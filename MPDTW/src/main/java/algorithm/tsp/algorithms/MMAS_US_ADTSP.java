...
import algorithm.tsp.aco.ls.us.USOperator;
...
public class MMAS_US_ADTSP implements Runnable {
    ...
    public MMAS_US_ADTSP(Graph graph, double rho, int maxIterations, double magnitude, int frequency, double alpha, double beta) {
