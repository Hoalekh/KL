package algorithm.vrp.mpdptw;

import algorithm.vrp.dvrptw.DVRPTW_ACS_Test;
import algorithm.vrp.mpdptw.alns.ALNS;
...
public class MPDPTW_ALNS_TEST {
    ...
    public void mpdptw_large_4_25_1_test() throws Exception {
        ...
        assertThat(log.get(1)).isEqualTo("NEW BEST = Iter 1 Sol = [F = true, NV = 5, TC = 5265.66]");
        assertThat(log.get(2)).isEqualTo("NEW BEST = Iter 1 Sol = [F = true, NV = 4, TC = 4876.31]");
        assertThat(log.get(3)).isEqualTo("NEW BEST = Iter 82 Sol = [F = true, NV = 3, TC = 4585.85]");
    ...
    public void mpdptw_normal_4_25_1_test() throws Exception {
        ...
        assertThat(log.get(2)).isEqualTo("NEW BEST = Iter 14 Sol = [F = true, NV = 4, TC = 5108.86]");
    ...
    public void mpdptw_without_4_25_1_test() throws Exception {
        ...
        assertThat(log.get(2)).isEqualTo("NEW BEST = Iter 2 Sol = [F = true, NV = 3, TC = 3982.77]");
        assertThat(log.get(3)).isEqualTo("NEW BEST = Iter 265 Sol = [F = true, NV = 3, TC = 3979.5]");
    ...
    public void mpdptw_large_8_50_1_test() throws Exception {
        ...
        assertThat(log.get(2)).isEqualTo("NEW BEST = Iter 4 Sol = [F = true, NV = 5, TC = 6221.15]");
    ...
    public void mpdptw_without_8_50_1_test() throws Exception {
        ...
        assertThat(log.get(2)).isEqualTo("NEW BEST = Iter 3 Sol = [F = true, NV = 3, TC = 4655.42]");
        assertThat(log.get(3)).isEqualTo("NEW BEST = Iter 54 Sol = [F = true, NV = 3, TC = 4567.49]");
        assertThat(log.get(4)).contains("Instance = w_8_50_1.txt\n" +
                "Best solution feasibility = true\n" +
                "Routes\n" +
                "0 42 22 21 46 45 47 44 15 13 43 11 19 18 12 14 16 17 20 48 23 0\n" +
                "0 29 25 33 1 31 26 32 28 24 2 30 34 27 0\n" +
                "0 5 36 40 49 38 39 4 9 35 37 3 6 8 7 10 50 41 0\n" +
                "Requests\n" +
                "2 4 3 8\n" +
                "0 5 6\n" +
                "1 7 9\n" +
                "Cost = 4567.489504283678\n" +
                "Num. vehicles = 3");
    }
    ...
    public void mpdptw_without_8_25_3_test() throws Exception {
        ...
        assertThat(log.get(3)).isEqualTo("NEW BEST = Iter 184 Sol = [F = true, NV = 2, TC = 2951.13]");
        assertThat(log.get(4)).isEqualTo("NEW BEST = Iter 920 Sol = [F = true, NV = 2, TC = 2950.77]");
        assertThat(log.get(5)).contains("Instance = w_8_25_3.txt\n" +
                "Best solution feasibility = true\n" +
                "Routes\n" +
